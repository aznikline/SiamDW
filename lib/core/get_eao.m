...
addpath('/data/zpzhang/project3/vot-toolkit'); toolkit_path; % Make sure that VOT toolkit is in the path

pwd = ['/data/zpzhang/project3/vot-toolkit/', 'vot-workspace', year]  % year is a str (can not be a number)

cd(pwd)
[gt_sequences, experiments] = workspace_load();
